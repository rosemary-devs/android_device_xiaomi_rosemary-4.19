...
static const variant_info_t rosemary_p_info = {
    ...
    .marketname = "POCO M5s",
    .model = "2207117BPG",
    .build_fingerprint = "POCO/rosemary_p_global/rosemary:12/SP1A.210812.016/V14.0.8.0.TKLMIXM:user/release-keys",
...
static const variant_info_t secretr_info = {
    ...
    .model = "22087RA4DI",
    .build_fingerprint = "Redmi/secret_global2/secret:12/SP1A.210812.016/V14.0.8.0.TKLMIXM:user/release-keys",
